...
public class RegisterCommand implements Command {
	...
	// register --username <username> --password <password> --first-name <firstName>
	// --last-name <lastName> --email <email>

	private final static int FIRSTNAME_STARTING_INDEX = 6;
	private final static int LASTNAME_STARTING_INDEX = 8;
	private final static int EMAIL_STARTING_INDEX = 10;
